...
Zunächst werden in  Kapitel~\ref{sec:methoden}  wichtige Punkte zum wisschenschaftlichen Schreiben herausgestellt. Es geht um Formulierungen in wissenschftlichen Arbeiten allgemein in Abschnitt~ \ref{sec:writing} und die Darstellung von Bildern und Tabellen in Abschnitt~\ref{sec:bildertabs}. Insbesondere wird die korrekte Darstellung mathematischer Sachverhalte in Abschnitt~\ref{sec:formulas} erläutert. Abschnitt \ref{sec:zitieren} erklärt das richtige Zitieren, Abschnitt~\ref{sec:lizenzen} wie urheberrechtlicher Schutz gewährleistet werden kann und Abschnitt~\ref{sec:ethik} spricht ethische Aspekte der Abschlussarbeit an.


In Kapitel~\ref{sec:ergebnisse} werden die drei geforderten Ergebnisse einer Abschlussarbeit vorgestellt: die schriftliche Ausarbeitung, das Kolloquium und die Datenablage.
